...
Go-Down Stock  Unit	<select id="sellingunit"  class="form-control "  name="sellingunit"  required   style='width: 270px;'>
  ...
  <div class="row"> 
    ...
    <div class="col-4">
    Go-Down Stock :   <input type="text" value="0" readonly  class="form-control register_form " name="stock" id="stock" placeholder="stock" required  autocomplete="off" >
    </div>
    <div class="col-4">
 purchasing Unit Price:  <input type="text" class="form-control register_form " name="unitprice" id="unitprice" placeholder="unitprice" required  autocomplete="off" >
    </div>
  </div>
...
<P>
			...
			<b style="color:red;"> Sale/Usable Unit and Unit Price:</b>
                <thead>
                    <tr>
			 ...
			 <td>
       <select id="unit"  class="form-control unit" class="unit"  name="unit[]"  required   style='width: 400px;'>  
