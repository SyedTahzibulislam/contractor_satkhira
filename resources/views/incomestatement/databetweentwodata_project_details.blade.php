...
@endforeach
 ...
 <?php 
$total_expenses = $total_expenses_paid+$total_salary_amount+$money_return_back_from_project+$total_due_paymet+$total_caopnay_paid+$total_company_duepayment;

$total_earn =$total_paid_income+$money_given_by_owner_to_supervisor
+$total_due_collection+$total_company_refund;
