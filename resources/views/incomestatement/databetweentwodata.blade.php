...
@endforeach
 ...
 <?php 
$total_expenses = $total_expenses_paid+$total_salary_amount+$total_due_paymet+$total_invest_project+$total_withdrawl_bank+$total_withdrawl_owner+$total_company_paid + $total_due_paymet_company+$money_return_back_from_project_expenses;

$total_earn =$total_paid_income+$total_investment+$money_return_back_from_project+$total_come_from_bank
+$total_due_collection+ $money_back_company+$total_invest_project_income;
