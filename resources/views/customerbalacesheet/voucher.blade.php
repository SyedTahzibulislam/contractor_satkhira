...
<table>
 ...
 @foreach ( $o->producttransition as $t )
  <tr>
...
<td> Type: <?php   if ($o->type ==1) { ?> Sell : 

<?php } if ($o->type ==2) { ?> Due Payment by Customer:  <?php } if ($o->type ==3) { ?>

Product Return from Cutomer:  <?php } if ($o->type ==4) { ?>

Money Back to Cutomer for sell retun:  <?php } ?>
...
<p>
Formula:
If Balance is Negative that means You have a due to Customer.
If Balance is Positive that means Customer has a due to You. <br>
