...
$table->foreignId('moneyexchangeaccount_id')->nullable(); 
	...
	$table->foreignId('project_id')->nullable();
		...
		$table->tinyInteger('adjusttype')->nullable();  // 1-> onwe dund 2->accounant 3->project's fund	
			...
			// 10- due payment to company 11->agentcommission // 12-  externalincome transition //13-?externalincomeprovider due transition 13 14->money exchange id 15- due collection from provider 16- money given to taken from accountant
			$table->double('amount');
